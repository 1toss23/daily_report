...
public interface JpaConst {
	...
	String CLI_COL_SITUATION_FLAG = "situation_flag"; //商談状況FLAG
	String CLI_COL_REP = "report_id"; //顧客の関する日報ID
	String CLI_COL_CREATED_AT = "create_at"; //登録日時
	String CLI_COL_UPDATED_AT = "update_at"; //更新日時
